...
<section class="path-section">
	...
	<form id="tshirt-form" class="tshirt-form">
		...
		<div class="tshirt-size-holder clearfix">
			<input type="radio" name="tshirt-size" id="xlr" value="xlr">
			<label for="xlr" class="form-btn">xlr</label>
			<input type="radio" name="tshirt-size" id="lrg" value="lrg">
			<label for="lrg" class="form-btn">lrg</label>
			<input type="radio" name="tshirt-size" id="med" value="med">
			<label for="med" class="form-btn">med</label>
			<input type="radio" name="tshirt-size" id="sml" value="sml">
